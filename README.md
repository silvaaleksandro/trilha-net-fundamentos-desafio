...
## Desafio de projeto
Usar seus conhecimentos adquiridos no módulo de fundamentos, da trilha .NET da DIO.
...
## Solução
O código está pela metade
Dar continuidade obedecendo as regras descritas acima, para que no final, tenhamos um programa funcional. 